...
angular.module('testManager', ['ionic', 'ngCordova', 'testManager.controllers', 'testManager.services', 'pascalprecht.translate'])
  ...
  .config(function ($stateProvider, $urlRouterProvider, $translateProvider) {
    ...
    var translationsES = {
      ...
      CLOSE: 'Cerrar',
      CREATEDQUIZ: 'Añadido cuestionario ',
      /**STATS */
      SORT: 'Ordenar por :',
      ...
      /**FAVORITE */
      DELETEDFAVORITE1: 'Favorito ',
      DELETEDFAVORITE2: ' eliminado',
      /**TEST DETAILS */
      ...
      LABELINCORRECT: 'Incorrectas',
      LABELPARCIAL: 'Parciales',
    ...
    var translationsEN = {
      ...
      CANCELREMOVE: 'Cancel',
      /**FAVORITE */
      DELETEDFAVORITE1: 'Favorite ',
      DELETEDFAVORITE2: ' deleted',
      /**TEST DETAILS */
